document.addEventListener('DOMContentLoaded', function () {
    ...
    var valueTelefone;
    var inputPassword = document.getElementById('form-field-password');
    var valuePassword;
    ...
    inputPassword.addEventListener('input', function () {
        valuePassword = inputPassword.value;
    });
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                if (response.includes('email account exists')) {
                    ...
                    //Anular style da tratativa quando inserir um novo email
                    inputEmail.addEventListener('input', function () {
                        errorMessage.style.display = 'none';
                        inputError.placeholder = 'Insira o email';
                        inputError.style.border = 'none';
                        inputError.style.background = 'rgb(255,255,255)';
